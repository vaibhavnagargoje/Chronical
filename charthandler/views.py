...
DATA_MODEL_REGISTRY = {
    ...
    # Agriculture
    'DsaIrrigationprojects': 'charthandler.DsaIrrigationprojects',
    'DsaIrrigationfacilities': 'charthandler.DsaIrrigationfacilities',
    'DsaIrrigationbeneficiary': 'charthandler.DsaIrrigationbeneficiary',
    'DsaTubewellshandpumps': 'charthandler.DsaTubewellshandpumps',
    'DsaIrrigationwells': 'charthandler.DsaIrrigationwells',
    'AgcLanduse': 'charthandler.AgcLanduse',
    'AgcGrosscroppedarea': 'charthandler.AgcGrosscroppedarea',
    'DsaChemicalfertilizer': 'charthandler.DsaChemicalfertilizer',
    'AgcHoldingsarea': 'charthandler.AgcHoldingsarea',
    'AgcHoldingsnumber': 'charthandler.AgcHoldingsnumber',
    # Health
    ...
    'TransportARCAge':               'charthandler.TransportARCAge',
    'TransportARCCaseFine':          'charthandler.TransportARCCaseFine',
    'TransportARCFatalities':        'charthandler.TransportARCFatalities',
    'TransportARCGrievousInjuries':  'charthandler.TransportARCGrievousInjuries',
    'TransportARCInjuries':          'charthandler.TransportARCInjuries',
    'TransportARCMinorInjuries':     'charthandler.TransportARCMinorInjuries',
    'TransportARCModeTransport':     'charthandler.TransportARCModeTransport',
    'TransportARCMonth':             'charthandler.TransportARCMonth',
    'TransportARCRoadType':          'charthandler.TransportARCRoadType',
    'TransportARCTime':              'charthandler.TransportARCTime',
    'TransportARCTotalsInjuryDeath': 'charthandler.TransportARCTotalsInjuryDeath',
    # Transport & Communication — DSA (District Statistical Abstract)
    'TransportDSA100sqkm':           'charthandler.TransportDSA100sqkm',
    'TransportDSABus':               'charthandler.TransportDSABus',
    'TransportDSAMagazine':          'charthandler.TransportDSAMagazine',
    'TransportDSARoadMaterial':      'charthandler.TransportDSARoadMaterial',
    'TransportDSARoadType':          'charthandler.TransportDSARoadType',
    # Transport & Communication — TC Assets (Census)
    'TransportTCAssets':             'charthandler.TransportTCAssets',
    # Revenue & Expenditure — GDDP / GDVA
    'RevenueGDDPGDVA':               'charthandler.RevenueGDDPGDVA',
    'RevenueGDDPGDVAN':              'charthandler.RevenueGDDPGDVAN',
    'RevenueNDDPNDVA':               'charthandler.RevenueNDDPNDVA',
    'RevenueNDDPNDVAN':              'charthandler.RevenueNDDPNDVAN',
    # Revenue & Expenditure — Tax Revenue
    'RevenueDSAGST':                 'charthandler.RevenueDSAGST',
    'RevenueDSATaxRevenue':          'charthandler.RevenueDSATaxRevenue',
    'RevenueDSATaxRevenueN':         'charthandler.RevenueDSATaxRevenueN',
    # Revenue & Expenditure — Land Revenue
    'RevenueDSALandRevenue':         'charthandler.RevenueDSALandRevenue',
    ...
    # Revenue & Expenditure — Gram Panchayat
    'RevenueDSAGramPanchayat':       'charthandler.RevenueDSAGramPanchayat',
    'RevenueDSAGramPanchayatN':      'charthandler.RevenueDSAGramPanchayatN',
    # Revenue & Expenditure — Jilla Parishad
    'RevenueDSAJillaParishadExp':    'charthandler.RevenueDSAJillaParishadExp',
    'RevenueDSAJillaParishadInc':    'charthandler.RevenueDSAJillaParishadInc',
    'RevenueDSAJillaParishadN':      'charthandler.RevenueDSAJillaParishadN',
    # Revenue & Expenditure — Municipal Corporation
    'RevenueDSAMunicipalCorpExp':    'charthandler.RevenueDSAMunicipalCorpExp',
    'RevenueDSAMunicipalCorpInc':    'charthandler.RevenueDSAMunicipalCorpInc',
    'RevenueDSAMunCorpN':            'charthandler.RevenueDSAMunCorpN',
    # Revenue & Expenditure — Municipal Council
    'RevenueDSAMunicipalCounExp':    'charthandler.RevenueDSAMunicipalCounExp',
    'RevenueDSAMunicipalCounInc':    'charthandler.RevenueDSAMunicipalCounInc',
    'RevenueDSAMunicipalCounN':      'charthandler.RevenueDSAMunicipalCounN',
    # Revenue & Expenditure — Nagar Panchayat
    'RevenueDSANagarPanchayatExp':   'charthandler.RevenueDSANagarPanchayatExp',
    'RevenueDSANagarPanchayatInc':   'charthandler.RevenueDSANagarPanchayatInc',
    'RevenueDSANagarPanchayatN':     'charthandler.RevenueDSANagarPanchayatN',
    # Police
    'PoliceIPCTotal':                'charthandler.PoliceIPCTotal',
    'PoliceIPCHumanBody':            'charthandler.PoliceIPCHumanBody',
    'PoliceIPCProperty':             'charthandler.PoliceIPCProperty',
    'PoliceIPCPublicTranquility':    'charthandler.PoliceIPCPublicTranquility',
    'PoliceIPCDocPropertyMarks':     'charthandler.PoliceIPCDocPropertyMarks',
    'PoliceIPCMisc':                 'charthandler.PoliceIPCMisc',
    'PoliceSLLTotal':                'charthandler.PoliceSLLTotal',
    'PoliceSLLOffenseTypes':         'charthandler.PoliceSLLOffenseTypes',
    'PoliceWomenTotal':              'charthandler.PoliceWomenTotal',
    'PoliceWomenCrimeTypes':         'charthandler.PoliceWomenCrimeTypes',
    'PoliceCyberTotals':             'charthandler.PoliceCyberTotals',
    'PoliceCyberCrimeTypes':         'charthandler.PoliceCyberCrimeTypes',
    'PoliceCyberFraudTypes':         'charthandler.PoliceCyberFraudTypes',
    'PoliceDSAWomenChildrenTaluka':  'charthandler.PoliceDSAWomenChildrenTaluka',
    'PoliceInfrastructure':          'charthandler.PoliceInfrastructure',
    'PoliceEmployees':               'charthandler.PoliceEmployees',
    'PoliceCourtsFunctioning':       'charthandler.PoliceCourtsFunctioning',
    'PoliceCourtsJudgesCases':       'charthandler.PoliceCourtsJudgesCases',
    'PoliceCourtsOriginalCases':     'charthandler.PoliceCourtsOriginalCases',
    'PoliceCourtsAppealCases':       'charthandler.PoliceCourtsAppealCases',
    # Education
    'DropOutRateByGender':           'charthandler.DropOutRateByGender',
    'DropOutRateSchoolingStage':     'charthandler.DropOutRateSchoolingStage',
    'EducationLevels':               'charthandler.EducationLevels',
    'NoOfSchools':                   'charthandler.NoOfSchools',
    'NoOfSchoolsManagementType':     'charthandler.NoOfSchoolsManagementType',
    'NoOfSchoolsType':               'charthandler.NoOfSchoolsType',
    'NoOfTeachersByType':            'charthandler.NoOfTeachersByType',
    'StudentEnrollmentBoysVsGirls':  'charthandler.StudentEnrollmentBoysVsGirls',
    'StudentEnrollmentClassWise':    'charthandler.StudentEnrollmentClassWise',
    'StudentEnrollmentGirlsVsBoys':  'charthandler.StudentEnrollmentGirlsVsBoys',
    'StudentEnrollmentNumbers':      'charthandler.StudentEnrollmentNumbers',
    'TeacherCategory':               'charthandler.TeacherCategory',
    'TeacherSocialCategory':         'charthandler.TeacherSocialCategory',
    # Environment
    'EnvWildlifeProjects':           'charthandler.EnvWildlifeProjects',
    'EnvForestArea':                 'charthandler.EnvForestArea',
    'EnvForestDensity':              'charthandler.EnvForestDensity',
    'EnvNightLightIntensity':        'charthandler.EnvNightLightIntensity',
    'EnvRunoff':                     'charthandler.EnvRunoff',
    'EnvRainyDays':                  'charthandler.EnvRainyDays',
    'EnvRainfall':                   'charthandler.EnvRainfall',
    'EnvMinTemperature':             'charthandler.EnvMinTemperature',
    'EnvMaxTemperature':             'charthandler.EnvMaxTemperature',
    'EnvWindSpeed':                  'charthandler.EnvWindSpeed',
    'EnvWaterDeficit':               'charthandler.EnvWaterDeficit',
    'EnvHumidity':                   'charthandler.EnvHumidity',
    'EnvSoilMoisture':               'charthandler.EnvSoilMoisture',
    'EnvEvapotranspirationYearly':   'charthandler.EnvEvapotranspirationYearly',
    'EnvEvapotranspirationMonthly':  'charthandler.EnvEvapotranspirationMonthly',
    'EnvBorewells':                  'charthandler.EnvBorewells',
    'EnvDugwells':                   'charthandler.EnvDugwells',
}
