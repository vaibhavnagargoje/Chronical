    ...
    def handle(self, *args, **options):
        ...
        templates = [
            ...
            # ==================================================================
            {
                ...
                'additional_info': 'Aggregate total of all cognizable IPC crimes per district per yearA cognizable offense or case is defined as the one which an officer in charge of a police station may investigate without the order of a magistrate and effect arrest without warrant. They are categorized into cases under the Indian Penal Code (IPC) or Special and Local Laws (SLL).',
                'display_order': 1,
            },
            {
                ...
                'filter2_column': '',
                'show_filters': True,
                'chart_options': build_chart_options('Cases',disable_all_filter1=True),
                'description': 'National Crime Records Bureau (NCRB)',
                'additional_info': '',
                'display_order': 2,
            },
            ...
            },
            {
                ...
                'chart_options': build_chart_options('Cases'),
                'description': 'National Crime Records Bureau (NCRB)',
                'additional_info': 'A cognizable offense or case is defined as the one which an officer in charge of a police station may investigate without the order of a magistrate and effect arrest without warrant. They are categorized into cases under the Indian Penal Code (IPC) or Special and Local Laws (SLL).',
                'display_order': 7,
            },
            {
                ...
                'chart_options': build_chart_options('Cases',disable_all_filter1=True),
                'description': 'National Crime Records Bureau (NCRB)',
                'additional_info': 'Special and Local Laws (SLL) are laws other than the Indian Penal Code (IPC) that create criminal offences and prescribe punishments for specific issues or regions.',
                'display_order': 8,
            },
            {
            ...
            },
            {
                ...
                'filter2_column': '',
                'show_filters': True,
                'chart_options': build_chart_options('No. of Cases',disable_all_filter1=True),
                'description': 'National Crime Records Bureau (NCRB)',
                'additional_info': '',
                'display_order': 12,
            },
            ...
            },
            {
                ...
                'chart_options': build_chart_options('Cases'),
                'description': 'District Statistical Abstract (DSA)',
                'additional_info': 'An original case is a case heard first in a court that has original jurisdiction.',
                'display_order': 20,
            },
            {
                ...
                'chart_options': build_chart_options('Cases'),
                'description': 'District Statistical Abstract (DSA)',
                'additional_info': 'An appeal case is a case brought to a higher court to review and challenge the decision of a lower court.',
                'display_order': 21,
            },
        ]
