...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,1b42-2402-8100-3022-eca3-a07e-fb8a-bf63-c58b.ngrok-free.app').split(',')
...
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://1b42-2402-8100-3022-eca3-a07e-fb8a-bf63-c58b.ngrok-free.app',
    'https://1b42-2402-8100-3022-eca3-a07e-fb8a-bf63-c58b.ngrok-free.app',
]
...
MIDDLEWARE = [
    ...
    # 'Chronical.middleware.StaticAuthMiddleware',
